<template>
    <div>
        <header class="top-0 z-50 border-b border-gray-200 backdrop:blur dark:border-gray-800 -mb-px sticky">
            <div id="Header" class="flex items-center mx-auto px-4 justify-between gap-4 h-[4rem] lg:px-8 max-w-7xl sm:px-8">
                <div class="flex items-center lg:flex-1 gap-1.5">

                    <NuxtLink class="flex font-bold text-xl items-end dark:text-white text-gray-900 cursor-pointer" >
                        <span>
                ...
                <ul class="lg:flex hidden gap-x-8 items-center cursor-pointer">
                    <li class="relative">
